...
var XmlAsc = (function () {
    var o = function (k, v, o, l) { for (o = o || {}, l = k.length; l--; o[k[l]] = v)
        ; return o; }, $V0 = [1, 5], $V1 = [1, 4], $V2 = [2, 5, 7], $V3 = [1, 8], $V4 = [2, 5, 7, 11, 12], $V5 = [2, 12], $V6 = [1, 12], $V7 = [2, 5, 7, 8, 11, 12], $V8 = [7, 8], $V9 = [2, 7];
        ...
        performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */) {
            ...
            switch (yystate) {
                ...
                case 13:
                    ...
                    break;
                case 3:
                    this.$ = new L_Objeto("LISTA_OBJETOS");
                    this.$.getHijos().push($$[$0]);
                    break;
                case 4:
                    this.$ = new Objeto($$[$0 - 2]);
            ...
            performAction: function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
                ...
                switch ($avoiding_name_collisions) {
                    ...
                    case 32:
                        ...
                        break;
                    case 33:
                        document.getElementById("console").value += 'Este es un error léxico: ' + yy_.yytext + ', en la linea: ' + yy_.yylloc.first_line + ', en la columna: ' + yy_.yylloc.first_column + '\n';
                        break;
                }
            },
